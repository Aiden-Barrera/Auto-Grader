...
public class Polynomial implements Comparable<Polynomial> {
	...
	public int compareTo(Polynomial o) {
		if(Polynomial.this.getDegree() > o.getDegree()) {return 1;}
		else if(Polynomial.this.getDegree() < o.getDegree()) {return -1;}
		
		for(int i = Polynomial.this.getDegree(); i>= 0; i--) {
			if(Polynomial.this.coefficients[i] > o.coefficients[i]) {return 1;}
			else if(Polynomial.this.coefficients[i] < o.coefficients[i]) {return -1;}
		}
		return 0; // STUB
	}
