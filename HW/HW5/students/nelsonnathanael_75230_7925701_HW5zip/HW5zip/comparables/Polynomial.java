...
public class Polynomial implements Comparable<Polynomial> {
	...
	public int compareTo(Polynomial o) {
		...
		//checks if this polynomial degree is greater than compared polynomial
		if (this.degree > o.degree) {
			return 1;
		}
		
		//if degrees are the same, comparing coefficients
		...
		//else statement for if o polynomial has the higher degree
		else {
			return -1;
		}
		//if nothing else is returned, they are equal
		return 0; // STUB
	}
