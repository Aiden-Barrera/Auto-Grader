...
public class Polynomial implements Comparable<Polynomial> {
	...
	public int compareTo(Polynomial o) {
		// TO DO
		int differenceOfDegrees = this.degree - o.degree;
		...
		for (int index = this.degree; index>=0; index--) {
			int differenceOfCoefficients = this.coefficients[index] - o.coefficients[index];
			if (differenceOfCoefficients!=0) {
				return (differenceOfCoefficients);
			}
		}
