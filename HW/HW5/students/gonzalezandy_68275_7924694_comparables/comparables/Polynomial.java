...
public class Polynomial implements Comparable<Polynomial> {
	...
	public int compareTo(Polynomial o) {
		// TO DO
		if(this.degree > o.degree) { //Comparing degree's , will return 1 if this.degree is greater, the else if below returns -1 if the (other) o.degree is bigger.
			return 1;
		}else if (this.degree < o.degree) {
			return -1;
		}
		
		for(int i = this.degree ; i >=0 ; i--) {   //this for loop makes the i the degree in order to compare coefficents, 
