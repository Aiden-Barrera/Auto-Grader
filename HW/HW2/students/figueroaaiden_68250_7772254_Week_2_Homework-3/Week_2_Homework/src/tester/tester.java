...
public class tester {
	...
	public static void main(String[] args) {
		System.out.println("Test cases for grading Hw2 - Polynomials:\n");
			...
			System.out.println("Polynomial p1 (default): " + p1);  
			System.out.println("Degree of p1: " + p1.getDegree()); 
			
			int[] coeffs2 = {1, 2, 1};
			Polynomial p2 = new Polynomial(coeffs2);
			System.out.println("Polynomial p2 (x^2 + 2x + 1): " + p2); 
			System.out.println("Degree of p2: " + p2.getDegree()); 
	
			p2.multiplyBy(3);
			System.out.println("p2 after multiplication by 3: " + p2);  
	
			int[] coeffs3 = {1, -2, 3};  // 3x^2 - 2x + 1
			Polynomial p3 = new Polynomial(coeffs3);
			p2.add(p3);
			System.out.println("p2 after adding p3: " + p2);  
	
			p2.subtract(p3);
			System.out.println("p2 after subtracting p3: " + p2);  
		
			System.out.println("Linear Polynomial p1: " + p1);  
			System.out.println("Degree of p1: " + p1.getDegree());  
	
			double[] solutions = p1.solve();
			System.out.println("Solutions for p1: " + Arrays.toString(solutions));  
	
			System.out.println("Linear Polynomial p2: " + p2);  
	
			solutions = p2.solve();
			System.out.println("Solutions for p2: " + Arrays.toString(solutions));
		
			System.out.println("Quadratic Polynomial p1: " + p1);  
			System.out.println("Degree of p1: " + p1.getDegree());  
	
			System.out.println("Solutions for p1: " + Arrays.toString(solutions));  
	
			System.out.println("Quadratic Polynomial p2: " + p2); 
	
			solutions = p2.solve();
			System.out.println("Solutions for p2: " + Arrays.toString(solutions));  
			System.out.println("Quadratic Polynomial p3: " + p3); 
	
			// Test the solve function for p3 (no real solutions)
			solutions = p3.solve();
			System.out.println("Solutions for p3: " + Arrays.toString(solutions)); 
	}
