...
public class tester {
	...
	public static void polynomialMethods() {
		...
		//Evaluate
		System.out.println(String.format("p3(2.5): %s", testPolynomials[3].atPoint((float) 2.5)));
		...
		//Add p8 to p9
				testPolynomials[9].add(testPolynomials[8]);
				System.out.println(String.format("p8+p1: %s , degree %s", testPolynomials[9],
						testPolynomials[7].getDegree()));
		...
		System.out.println(String.format("p5+p6: %s , degree %s", testPolynomials[5], 
				testPolynomials[5].getDegree())); //was originally get p6's degree but should've been 5, was messing up my code
