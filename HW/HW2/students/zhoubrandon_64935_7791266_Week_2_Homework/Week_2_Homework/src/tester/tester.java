...
public class tester {
	...
	public static void testLinearPolynomial() {
        System.out.println("Testing Linear Polynomial:");
        LinearPolynomial lp = new LinearPolynomial(5, 2);
        System.out.println("Linear Polynomial: " + lp);
        double[] solutions = lp.solve();
    ...
    public static void testQuadraticPolynomial() {
        System.out.println("Test Quadratic Polynomial:");
        QuadraticPolynomial qp1 = new QuadraticPolynomial(1, -3, 2);
        QuadraticPolynomial qp2 = new QuadraticPolynomial(1, 2, 1);
        
        System.out.println("Quad Polynomial 1: " + qp1);
        printSolutions(qp1.solve());
        
        System.out.println("Quad Polynomial 2: " + qp2);
        printSolutions(qp2.solve());
